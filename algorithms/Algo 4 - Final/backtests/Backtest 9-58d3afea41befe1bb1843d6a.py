...
def handle_data(context,data):
    """
    Called every minute to calculate VWAP and work out whether to order or not.
    """
    ...
    if long_pos and rsi > overbought:#and downtrend:
        order_target_percent(spy, 0)
    if short_pos and rsi < oversold:#and uptrend:
        order_target_percent(spy, 0)
